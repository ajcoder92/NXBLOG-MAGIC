...
def generate_subcategory_blog_ideas(subcategory, products, collection_url):
    ...
    # Blog templates for variety
    templates = [
        {
            'title': f'Best {category_name} That Build Customer Trust (2025)',
            'description': 'Expert guide to signage that increases foot traffic and builds professional credibility',
            'category': 'Business Guide',
            'focus_keyword': f'best {category_name.lower()} 2025'
        },
        {
            'title': f'How {category_name} Affect Customer Perception',
            'description': 'Psychology-based analysis of how signage influences customer decisions and trust',
            'category': 'Business Psychology',
            'focus_keyword': f'{category_name.lower()} psychology'
        },
        {
            'title': f'{category_name} That Actually Increase Sales',
            'description': 'Data-driven examples of signage with proven ROI and conversion rates',
            'category': 'Sales Optimization',
            'focus_keyword': f'{category_name.lower()} increase sales'
        },
        {
            'title': f'Creative {category_name} That Go Viral on Social Media',
            'description': 'Instagram-worthy signage ideas that generate social media buzz and customer engagement',
            'category': 'Social Marketing',
            'focus_keyword': f'creative {category_name.lower()} viral'
        },
        {
            'title': f'Why {category_name} Are Essential for Modern Businesses',
            'description': 'Comprehensive analysis of signage trends and their impact on business success',
            'category': 'Business Trends',
            'focus_keyword': f'essential {category_name.lower()} modern business'
        }
    ]
...
"""
    ...
    try:
        ...
        if ai_model == 'claude':
            # Proper Anthropic client initialization
            try:
